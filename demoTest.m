...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data = load('ilkeLeftBody.csv'); %load 'Data'
%filteredSignalMat = medianFilterTest(Data(406:832,:));
%filteredSignalMat = medianFilterTest(Data);


% newData(:,1) = filteredSignalMat(:,1);
% newData(:,2:3) = filteredSignalMat(:,8:9);
newData(:,1) = Data(:,1);   
newData(:,2:3) = Data(:,9:10);
Data = newData';
nbVar = size(Data,1);
